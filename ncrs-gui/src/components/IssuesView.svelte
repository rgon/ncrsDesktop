<script lang="ts">
    ...
    import { mdiAlertCircleOutline, mdiSwapHorizontal, mdiCheck, mdiClockOutline } from '@mdi/js';
                    ...
                    <div class="alert alert-error shadow-none rounded-lg mb-1.5 py-2 px-3">
                        <div class="flex flex-col min-w-0 flex-1">
                            <div class="flex items-center justify-between gap-2">
                                <span class="badge badge-sm badge-outline">{errorKindLabel(err.kind)}</span>
